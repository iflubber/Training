package learn.selenium.webdriver.selenium2.grid2;
...
public class GridTest {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		for(String browser: browsers) {
			RemoteWebDriver driver = DriverProvider.getDriver(browser);
			test1(driver);
		}

	}

	public static void test1(RemoteWebDriver driver) throws InterruptedException {
